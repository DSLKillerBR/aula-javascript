...
function soma(n1, n2){ //função de soma entre 2 números
    return n1 + n2
}
function validaIdade (idade){
    if (idade >= 18){
     validar = true //se maior ou igual a 18, validar é true
    } else{
        validar = false //se não, é false
    }
    return validar //imprime a variável validar
}
